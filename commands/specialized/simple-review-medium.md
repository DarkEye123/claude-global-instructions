...
do a code-review against branch origin/develop (if detected, if not, against origin/main)
Use `gh` tool and read available PR comments before your review begins to gather the context. 

Export your findings in readable & easy to follow manner into claude-simple-medium-review.md.
